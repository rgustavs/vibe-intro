...
- Save points | Commit working versions | Your safety net — see chapter 04.
...
<div class="grid-2 reveal">
  ...
  <div class="stack-sm">
    <div class="card"><div class="title" style="font-size: 19px;">No save points</div><p>Hours of changes with no way back. Commit working versions so you can always undo — chapter 04.</p></div>
